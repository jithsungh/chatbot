      ...
      <div className="message-content">
        ...
        {message.followup && (
          <div className="followup-question">
            <div className="followup-text">{message.followup}</div>
          </div>
        )}
        {message.metadata && (
          <div className="message-metadata">
            {message.metadata.org_related && (
              <span className="metadata-tag org-related">
                Organization Related
              </span>
            )}
            {message.metadata.has_context && (
              <span className="metadata-tag has-context">
                Context Available
              </span>
            )}
          </div>
